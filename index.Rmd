...
Definimos os caracteres para a configuração "UTF-8 - all languagues", modelo mais amplo de codificação de caracteres ASCII para interterpretação pela linguagem binária dos processadores computacionais.

Inserimos o idioma utilizado e selecionamos o dicionário padrão para o Português criado pela Universidade Federal de Santa Catarina.
